#!/bin/bash
# FedAvg -Full SL
# python proto_fssl.py --exp_name fedavg_cifar10 --dataset cifar10 --model res9 --is_sl --num_label 54  --local_episode 5
# python proto_fssl.py --exp_name fedavg_cifar10_nid --dataset cifar10 --model res9 --is_sl --num_label 54  --local_episode 5 --non_iid
...
# python proto_fssl.py --exp_name cifar10_res18_bn --dataset cifar10 --model res18 --bn_type bn
# python proto_fssl.py --exp_name cifar10_res18_bn_nid --dataset cifar10 --model res18 --non_iid --bn_type bn
...
# python proto_fssl.py --exp_name cifar10_noise_0.05 --dataset cifar10 --model res9 --use_noise --stddev 0.05
...
# python proto_fssl.py --exp_name cifar10_nid_noise_0.05 --dataset cifar10 --model res9 --use_noise --stddev 0.05 --non_iid
...
# python proto_fssl.py --exp_name stl10_noise_0.05 --dataset stl10 --model res9 --num_label 10 --num_unlabel 980 --use_noise --stddev 0.05
# python proto_fssl.py --exp_name stl10_noise_0.1 --dataset stl10 --model res9 --num_label 10 --num_unlabel 980 --use_noise --stddev 0.1
